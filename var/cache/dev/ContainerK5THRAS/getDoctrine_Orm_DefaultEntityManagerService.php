...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')], true)), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\AppUserRepository' => ['services', 'App\\Repository\\AppUserRepository', 'getAppUserRepositoryService', true],
            'App\\Repository\\BlogPostRepository' => ['services', 'App\\Repository\\BlogPostRepository', 'getBlogPostRepositoryService', true],
            'App\\Repository\\CommentRepository' => ['services', 'App\\Repository\\CommentRepository', 'getCommentRepositoryService', true],
            'App\\Repository\\UserProfileRepository' => ['services', 'App\\Repository\\UserProfileRepository', 'getUserProfileRepositoryService', true],
        ], [
