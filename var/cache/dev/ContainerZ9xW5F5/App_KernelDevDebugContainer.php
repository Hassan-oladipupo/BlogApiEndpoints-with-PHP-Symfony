...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FollowersController' => 'getFollowersControllerService',
            'App\\Controller\\LikeController' => 'getLikeControllerService',
            'App\\Controller\\ProfileController' => 'getProfileControllerService',
            'App\\Controller\\ProfileSettingController' => 'getProfileSettingControllerService',
            'App\\Controller\\UserController' => 'getUserControllerService',
            'App\\Repository\\AppUserRepository' => 'getAppUserRepositoryService',
            'App\\Repository\\BlogPostRepository' => 'getBlogPostRepositoryService',
            'App\\Repository\\CommentRepository' => 'getCommentRepositoryService',
            'App\\Repository\\UserProfileRepository' => 'getUserProfileRepositoryService',
            'App\\Security\\JWTManager' => 'getJWTManagerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S5DqcbsF8F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_FirewallService()
    {
        ...
        $c = new \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()));
        $c->registerListener('main', 'app_auth_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.FbeHDom'] ?? $this->load('get_Security_RequestMatcher_FbeHDomService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'profiles_directory' => (\dirname(__DIR__, 4).'/public/uploads/profiles/'),
            ...
            'lexik_jwt_authentication.token_ttl' => 172800,
