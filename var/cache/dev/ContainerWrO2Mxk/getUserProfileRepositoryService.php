...
{
    /**
     * Gets the public 'App\Repository\UserProfileRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserProfileRepository.php';

        return $container->services['App\\Repository\\UserProfileRepository'] = new \App\Repository\UserProfileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
