...
class UserController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager, ValidatorInterface $validator, AppUserRepository $repo): JsonResponse
    {
    ...
    public function confirmEmail(Request $request, AppUserRepository $repo, EntityManagerInterface $entityManager): JsonResponse
    {
        try {
